* ---------------------------------------------------------------------------
* OutputDataSetsUIMacro_EmpQCEW_Beg.do  ->  output/factor_inputs/EmpQCEW_Beg/  (tab:macroeffects_beg
*                                           Employment column, QWI-separation diff)
*
* QWI-separation ("beg") analog of OutputDataSetsUIMacro_EmpQCEW.do. QBLS contract:
*   col 4  diff_logmeanwks       (benefit weeks; RHS regressor)
*   col 5  qdsbk1_logqcew_emp    QCEW employment, QWI-beg quasi-diff   (var_ind 5)
*
* NOT vacancy-gated -- QCEW county employment is public; fully shippable on either
* DataControls vintage.
* ---------------------------------------------------------------------------
...
forvalues i=1/`maxid'{
	disp(`i')
	outsheet fipsnumeric year quarter diff_logmeanwks qdsbk1_logqcew_emp ///
